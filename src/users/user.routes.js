...
router.post('/', auth, audited('user'), role(['SNT_SUPER', 'COMPANY_ADMIN', 'ADMIN']), checkQuota('users'), validate({
...
router.put('/:id', auth, audited('user'), role(['SNT_SUPER', 'COMPANY_ADMIN', 'ADMIN']), validate({
...
router.delete('/:id', auth, audited('user'), role(['SNT_SUPER', 'COMPANY_ADMIN', 'ADMIN']), ctrl.remove);
